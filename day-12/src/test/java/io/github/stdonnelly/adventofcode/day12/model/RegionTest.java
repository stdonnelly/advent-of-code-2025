...
class RegionTest {
  ...
  static Stream<Arguments> regionProvider() {
    return Stream.of(
        arguments("4x4: 0 0 0 0 2 0", new Region(4, 4, new int[] {0, 0, 0, 0, 2, 0})),
        arguments("12x5: 1 0 1 0 2 2", new Region(12, 5, new int[] {1, 0, 1, 0, 2, 2})),
        arguments("12x5: 1 0 1 0 3 2", new Region(12, 5, new int[] {1, 0, 1, 0, 3, 2})));
  }
}
