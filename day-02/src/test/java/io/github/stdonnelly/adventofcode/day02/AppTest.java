...
class AppTest {
   ...
   *
   * <p>This is to check an assumption before writing the actual code.
   *
   * @param inputFileName The file to check. This is parameterized because I want to check both the
   *     example and the real input.
   * @throws IOException if the input loading fails
   */
  @ParameterizedTest
