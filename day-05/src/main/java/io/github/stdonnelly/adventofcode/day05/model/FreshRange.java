...
// TODO: Make the one from day 2 a different package and just use that one
// This one is also inclusive and used to check other numbers
...
public record FreshRange(long start, long end) {
  ...
  //  */
  // public static FreshRange parse(String input) throws IllegalArgumentException {
